...
# dbt job
addEventListObject = AddEvents([EventOutAdd(event="dbtJob")])
...
# basic job
#waitForEventList = WaitForEvents([Event(event="dbtJob")])
#myJob = JobCommand('dbtJob', command='echo "Hello world!"', run_as='controlm')

#myJob.event_list.append(waitForEventList)
